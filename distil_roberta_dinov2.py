...
TEST_PATH = './test.csv'
IMAGE_DIR = './images'
OUTPUT_PATH = 'Submission_distil_roberta_dinov2.csv'
CHECKPOINT_DIR = 'distil_roberta_dinov2_checkpoints'

# Model Configuration
TEXT_MODEL_NAME = 'distilbert/distilroberta-base'
...
RESUME_FROM_CHECKPOINT = '/hdd5/shobhit/envs/amz/distil_roberta_dinov2_checkpoints/fusion-00-57.4889.ckpt'  
