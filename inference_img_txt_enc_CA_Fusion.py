...
def parse_args():
    ...
    parser.add_argument(
        '--checkpoint',
        type=str,
        default='/hdd5/shobhit/envs/amz/distil_roberta_dinov2_checkpoints/fusion-epoch=09-val_smape=47.1570.ckpt',
    ...
    parser.add_argument(
        '--output',
        type=str,
        default='Submission_distilRoberta_dinov2-Fusion.csv',
